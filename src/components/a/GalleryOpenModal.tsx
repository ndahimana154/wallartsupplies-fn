...
const GalleryOpenModal = ({ onClose, galleryImages,galleryOpen ,gidx}: any) => {
        const [galleryIndex, setGalleryIndex] = useState(gidx ||0);
        const prevGallery = useCallback(() => {
            setGalleryIndex((i) => (i - 1 + galleryImages.length) % (galleryImages.length || 1));
        ...
        // Keyboard navigation for the gallery modal
        useEffect(() => {
